...
namespace Basler_ImageFormatConverterParams
{
    ...
    */
    ...
    static_cast<GenApi::CEnumerationTRef<InconvertibleEdgeHandlingEnums> *> (&InconvertibleEdgeHandling )->SetNumEnums(2);
	static_cast<GenApi::CEnumerationTRef<InconvertibleEdgeHandlingEnums> *> (&InconvertibleEdgeHandling )->SetEnumReference( InconvertibleEdgeHandling_SetZero, "SetZero" );		static_cast<GenApi::CEnumerationTRef<InconvertibleEdgeHandlingEnums> *> (&InconvertibleEdgeHandling )->SetEnumReference( InconvertibleEdgeHandling_Clip, "Clip" );		static_cast<GenApi::CEnumerationTRef<OutputBitAlignmentEnums> *> (&OutputBitAlignment )->SetReference(_Ptr->GetNode("OutputBitAlignment"));
