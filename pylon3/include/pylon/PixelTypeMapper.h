...
namespace Pylon
{
    ...
    */
    ...
    public:
        ...
        /// create and initioalize a mapper by using the enum node passed.
    ...
    public:
        ...
        */
        ...
        /*! \brief Lazy initialisation of the object.
    ...
    public:
        ...
        */
        ...
        /*! \brief Returns a Pylon::EPixelType for a given symbolic name.
            ...
            Passing "Mono16" will return Pylon::PixelType_Mono16. If the name is not found Pylon::PixelType_Undefined will be returned.
        */
        static EPixelType GetPylonPixelTypeByName(const GenICam::gcstring& symbolicName)
        {
        ...
        /*! \brief Static function that returns a string representation of the given EPixelType.
            ...
            \return Returns the pointer to a null terminated string representing the symbolic name of the pixeltype.
        ...
        */
        static const char* GetNameByPixelType(EPixelType pixelType);
    ...
    */
    ...
    public:
        ...
        */
        ...
        /*! \copydoc CPixelTypeMapper::GetPylonPixelTypeByName(const GenICam::gcstring&)
        */
        static EPixelType GetPylonPixelTypeByName(const GenICam::gcstring& symbolicName)
        {
        ...
        /*! \copydoc CPixelTypeMapper::GetNameByPixelType(PixelType)
        */
        static const char* GetNameByPixelType(EPixelType pixelType);
