...
/*!
\file
\brief    Low Level API: Definition of a of types concerning grabbed data.
*/
...
// Because of this, the following lines must ba AFTER #include limits.h
#ifndef SIZE_MAX
...
#define BIT_PER_PIXEL( pixelType ) ( ( (pixelType) >> 16 ) & 0xff )
    ...
    */
    ...
    public:
        ...
        /// Get the index of the grabbed frame.
        /*!
        In case of GigE-Vision this sequence number starts with 1 and
        wraps around at 65535. The value 0 has the special meaning
        that this feature is not supported by the camera.

        This index is specific to a single stream.
        */
