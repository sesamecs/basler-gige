    ...
    public:
        ...
        */
        ...
        \error
            ...
            The grabbing is stopped with StopGrabbing() if the OnGrabStarted event call triggers an exception.
        ...
        */
        ...
        <li> If the %Pylon Device has been opened by StartGrabbing and no other camera object service requires it to be open, it is closed by calling Close().
