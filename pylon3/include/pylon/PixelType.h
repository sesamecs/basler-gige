...
#define PIXEL_BIT_COUNT(n) ((n) << 16)
    ...
    The camera User's Manual provides more information on pixel formats and the the memory layout of the image data.
    */
    enum EPixelType
    {
        ...
        PixelType_Mono8signed        = PIXEL_MONO | PIXEL_BIT_COUNT(8)  | 0x0002,  ///< alias PixelFormat_Mono8signed
        PixelType_Mono10             = PIXEL_MONO | PIXEL_BIT_COUNT(16) | 0x0003,  ///< alias PixelFormat_Mono10
        PixelType_Mono10packed       = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x0004,  ///< alias PixelFormat_Mono10packed or PixelFormat_Mono10p
        PixelType_Mono12             = PIXEL_MONO | PIXEL_BIT_COUNT(16) | 0x0005,  ///< alias PixelFormat_Mono12
        PixelType_Mono12packed       = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x0006,  ///< alias PixelFormat_Mono12packed or PixelFormat_Mono12p
        ...
        PixelType_RGB8packed         = PIXEL_COLOR | PIXEL_BIT_COUNT(24) | 0x0014,  ///< alias PixelFormat_RGB8packed
        PixelType_BGR8packed         = PIXEL_COLOR | PIXEL_BIT_COUNT(24) | 0x0015,  ///< alias PixelFormat_BGR8packed or PixelFormat_BGR8

        PixelType_RGBA8packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(32) | 0x0016,  ///< alias PixelFormat_RGBA8packed
        PixelType_BGRA8packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(32) | 0x0017,  ///< alias PixelFormat_BGRA8packed or PixelFormat_BGRa8

        PixelType_RGB10packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0018,  ///< alias PixelFormat_RGB10packed
        PixelType_BGR10packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0019,  ///< alias PixelFormat_BGR10packed or PixelFormat_BGR10

        PixelType_RGB12packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x001a,  ///< alias PixelFormat_RGB12packed
        PixelType_BGR12packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x001b,  ///< alias PixelFormat_BGR12packed or PixelFormat_BGR12

        PixelType_RGB16packed        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0033,  ///< alias PixelFormat_RGB16packed
        ...
        PixelType_YUV411packed       = PIXEL_COLOR | PIXEL_BIT_COUNT(12) | 0x001e,  ///< alias PixelFormat_YUV411packed
        PixelType_YUV422packed       = PIXEL_COLOR | PIXEL_BIT_COUNT(16) | 0x001f,  ///< alias PixelFormat_YUV422packed
        PixelType_YUV444packed       = PIXEL_COLOR | PIXEL_BIT_COUNT(24) | 0x0020,  ///< alias PixelFormat_YUV444packed

        PixelType_RGB8planar         = PIXEL_COLOR | PIXEL_BIT_COUNT(24) | 0x0021,  ///< alias PixelFormat_RGB8planar
        PixelType_RGB10planar        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0022,  ///< alias PixelFormat_RGB10planar
        PixelType_RGB12planar        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0023,  ///< alias PixelFormat_RGB12planar
        PixelType_RGB16planar        = PIXEL_COLOR | PIXEL_BIT_COUNT(48) | 0x0024,  ///< alias PixelFormat_RGB16planar
        ...
        PixelType_BayerGR12Packed    = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x002A,  ///< alias PixelFormat_BayerGR12Packed or PixelFormat_BayerGR12p
        PixelType_BayerRG12Packed    = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x002B,  ///< alias PixelFormat_BayerRG12Packed or PixelFormat_BayerRG12p
        PixelType_BayerGB12Packed    = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x002C,  ///< alias PixelFormat_BayerGB12Packed or PixelFormat_BayerGB12p
        PixelType_BayerBG12Packed    = PIXEL_MONO | PIXEL_BIT_COUNT(12) | 0x002D,  ///< alias PixelFormat_BayerBG12Packed or PixelFormat_BayerBG12p
