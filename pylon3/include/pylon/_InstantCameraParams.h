...
namespace Basler_InstantCameraParams
{
    ...
    */
    ...
    //@{
	/*!	
		\brief Enables/disables the grabbing of camera events while images are grabbed. Is writable when the instant camera object is closed.
    ...
    */
    ...
    //@{
	/*!	
		\brief The instant camera object is set to monitor mode when enabled, e.g. when using the GigE multicast feature. Is writable when the instant camera object is closed.
