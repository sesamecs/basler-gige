...
*/
#ifndef INCLUDED_BASLERGIGECONFIGURATIONEVENTHANDLER_H_01627755
#define INCLUDED_BASLERGIGECONFIGURATIONEVENTHANDLER_H_01627755
...
namespace Pylon
{
    ...
    */
    ...
    public:
        /**
        \brief This method is called before a :IPylonDevice) is attached by calling the Instant Camera object's Attach() method.
        ...
        */
        ...
        /**
        \brief This method is called after a :IPylonDevice) has been attached by calling the Instant Camera object's Attach() method.
        This method can not be used for detecting that a camera device has been attached to the PC.
        The camera's Attach() method must not be called from here or from subsequent calls to avoid infinite recursion.
        \param[in]  camera The source of the call.
        \error
        ...
        */
        ...
        /**
        \brief This method is called when camera device removal from the PC has been detected.
...
#   pragma pack(pop)
#endif /* _MSC_VER */
#endif /* INCLUDED_BASLERGIGECONFIGURATIONEVENTHANDLER_H_01627755 */
