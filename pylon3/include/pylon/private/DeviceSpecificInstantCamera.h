...
namespace Pylon
{
    ...
    */
    ...
    void CDeviceSpecificInstantCameraT<CameraTraitsT>::Attach( IPylonDevice* pDevice, ECleanup cleanupProcedure)
    {
        ...
        GenApi::AutoLock lock( CInstantCamera::GetLock());
        // Attach the device.
    ...
    void CDeviceSpecificInstantCameraT<CameraTraitsT>::RegisterConfiguration( typename CameraTraitsT::ConfigurationEventHandler_t* pConfigurator, ERegistrationMode mode, ECleanup cleanupProcedure)
    {
        ...
        InternalRegisterConfiguration( pConfigurator ? new TieT(pConfigurator) : NULL, mode, cleanupProcedure, pConfigurator ? &pConfigurator->DebugGetEventHandlerRegistrationCount() : NULL);
    }
    ...
    void CDeviceSpecificInstantCameraT<CameraTraitsT>::RegisterImageEventHandler( typename CameraTraitsT::ImageEventHandler_t* pImageEventHandler, ERegistrationMode mode, ECleanup cleanupProcedure)
    {
        ...
        InternalRegisterImageEventHandler( pImageEventHandler ? new TieT(pImageEventHandler) : NULL, mode, cleanupProcedure, pImageEventHandler ? &pImageEventHandler->DebugGetEventHandlerRegistrationCount() : NULL);
    }
        ...
        ECameraEventAvailability availability)
    {
        ...
        InternalRegisterCameraEventHandler( pCameraEventHandler ? new TieT(pCameraEventHandler) : NULL, nodeName, userProvidedId, mode, cleanupProcedure, availability, pCameraEventHandler ? &pCameraEventHandler->DebugGetEventHandlerRegistrationCount() : NULL);
    }
