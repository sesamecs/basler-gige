    ...
    class LOG4CPP_EXPORT Category {
        ...
        */       
        ...
        inline bool isDebugEnabled() throw() { 
            if( !_ValidDebugEnabledCache )
            {
                _DebugEnabled = isPriorityEnabled(Priority::DEBUG);
                _ValidDebugEnabledCache = true;
            }
        ...
        **/  
        ...
        inline bool isInfoEnabled() throw() { 
            if( !_ValidInfoEnabledCache )
            {
                _InfoEnabled = isPriorityEnabled(Priority::INFO);
                _ValidInfoEnabledCache = true;
            }
            return _InfoEnabled;
        };
        ...
        inline bool isWarnEnabled() throw() { 
            if( !_ValidWarnEnabledCache )
            {
                _WarnEnabled = isPriorityEnabled(Priority::WARN);
                _ValidWarnEnabledCache = true;
            }
            return _WarnEnabled;
        };
